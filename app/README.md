...
This directory contains the Electron desktop shell, React/Vite interface, local Node adapters, and tests. See the [root README](../README.md) and [contribution guide](../CONTRIBUTING.md) for setup.
