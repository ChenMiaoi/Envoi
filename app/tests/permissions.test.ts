...
import {authorizedRoots,rememberRoot,recentProjects,rememberProject} from '../src/lib/recentProjects';
...
test('desktop locations and recent projects persist paths separately without browser permissions',async()=>{
 await rememberRoot('/papers');await rememberProject('/papers/my-paper');await rememberRoot('/papers');
