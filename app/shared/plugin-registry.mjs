import asm from "../plugins/asm/manifest.json" with { type: "json" }
...
import wsl from "../plugins/wsl/manifest.json" with { type: "json" }
...
const loaded = loadPlugins([cpp, python, rust, remoteSsh, wsl, lean, rtl, asm])
