...
export function ProjectProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(()=>{
    ...
    void saveSession(project).catch(()=>setMessage('浏览器恢复缓存写入失败；未保存编辑仍在当前窗口，请保存源文件后再刷新。'));
  },[project,restored]);
  useEffect(() => {
