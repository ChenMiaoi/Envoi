...
export function WelcomePage(){
 ...
 return <main data-testid="welcome-page" className="h-full overflow-auto bg-background">
  <div className="mx-auto flex min-h-full max-w-5xl flex-col px-6 py-10 sm:px-12 lg:py-16">
