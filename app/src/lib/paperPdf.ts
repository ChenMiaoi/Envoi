...
export function paperPdf(project:PaperProject) {
 if(project.compiled&&JSON.parse(project.compiled.signature)[0]===project.rootId)return {id:'compiled',path:'build/main.pdf',file:project.compiled.file,url:undefined};
