...
const KIND: Record<string, string> = {
  note: 'note', info: 'note', todo: 'todo', abstract: 'abstract', summary: 'abstract', tldr: 'abstract',
  tip: 'tip', hint: 'tip', success: 'tip', check: 'tip', done: 'tip',
  question: 'question', help: 'question', faq: 'question',
  warning: 'warning', caution: 'warning', attention: 'warning',
  important: 'important', example: 'example', quote: 'quote', cite: 'quote',
  failure: 'danger', fail: 'danger', missing: 'danger', danger: 'danger', error: 'danger', bug: 'danger',
};
const LABEL: Record<string, string> = {
  note: 'Note', todo: 'Todo', abstract: 'Abstract', tip: 'Tip', question: 'Question',
  warning: 'Warning', important: 'Important', example: 'Example', quote: 'Quote', danger: 'Danger',
};
...
export function rehypeCallouts() {
  return (tree: Root) => {
    const walk = (node: Root | Element) => {
      ...
      node.children.forEach(child => { if (child.type === 'element') walk(child); });
    };
    walk(tree);
  };
}
