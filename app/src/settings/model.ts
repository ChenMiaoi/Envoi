...
export interface Preferences {version:1;bindings:string[];uiFontFamily:TextFont;uiFontSize:number;previewFontFamily:TextFont;previewFontSize:number;accent:'lemon'|'blue'|'green'|'rose';fontSize:number;fontFamily:'system'|'menlo'|'monaco';lineHeight:number;tabSize:number;disabledRules:number[];engine:Engine;lintEnabled:boolean;defaultGit:boolean}
export interface ProjectConfiguration {version:1;overrides:{engine?:Engine;lintEnabled?:boolean;disabledRules?:number[]}}
export const defaults:Preferences={version:1,bindings:[],uiFontFamily:'system',uiFontSize:13,previewFontFamily:'system',previewFontSize:14,accent:'lemon',fontSize:12.5,fontFamily:'system',lineHeight:1.75,tabSize:4,disabledRules:[],engine:'pdflatex',lintEnabled:true,defaultGit:true};
