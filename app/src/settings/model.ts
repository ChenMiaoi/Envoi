...
export interface Preferences {version:1;language:LocaleId;bindings:string[];uiFontFamily:TextFont;uiFontSize:number;previewFontFamily:TextFont;previewFontSize:number;theme:ThemeId;accent:'lemon'|'blue'|'green'|'rose';fontSize:number;fontFamily:'system'|'menlo'|'monaco';lineHeight:number;tabSize:number;disabledRules:number[];engine:Engine;lintEnabled:boolean;defaultGit:boolean}
export interface ProjectConfiguration {version:1;overrides:{engine?:Engine;lintEnabled?:boolean;disabledRules?:number[]}}
export const defaults:Preferences={version:1,language:'zh-CN',bindings:[],uiFontFamily:'system',uiFontSize:13,previewFontFamily:'system',previewFontSize:14,theme:'graphite',accent:'lemon',fontSize:12.5,fontFamily:'system',lineHeight:1.75,tabSize:4,disabledRules:[],engine:'pdflatex',lintEnabled:true,defaultGit:true};
/** 主题完整色板定义在 index.css 的 [data-theme] 块中；这里只保存元数据与设置页预览色。 */
export type ThemeId='graphite'|'classic'|'midnight'|'forest'|'paper'|'mist';
export const themes:Record<ThemeId,{labelKey:MessageKey;mode:'dark'|'light';swatch:{bg:string;panel:string}}>={
 graphite:{labelKey:'theme.graphite',mode:'dark',swatch:{bg:'#23272e',panel:'#2d333c'}},
 classic:{labelKey:'theme.classic',mode:'dark',swatch:{bg:'#18181b',panel:'#252526'}},
 midnight:{labelKey:'theme.midnight',mode:'dark',swatch:{bg:'#1a1e28',panel:'#262c3a'}},
...
export const accents={lemon:{labelKey:'accent.lemon' as MessageKey,hsl:'57 62% 83%',light:'46 72.4% 28.4%'},blue:{labelKey:'accent.blue' as MessageKey,hsl:'208 58% 71%',light:'215 56.3% 42.2%'},green:{labelKey:'accent.green' as MessageKey,hsl:'120 34% 72%',light:'127 33.3% 35.9%'},rose:{labelKey:'accent.rose' as MessageKey,hsl:'338 51% 75%',light:'335 48.7% 44.3%'}};
export const editorFonts={system:{labelKey:'font.editor.system' as MessageKey,css:'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace'},menlo:{labelKey:'font.editor.menlo' as MessageKey,css:'Menlo, ui-monospace, monospace'},monaco:{labelKey:'font.editor.monaco' as MessageKey,css:'Monaco, ui-monospace, monospace'}};
export const textFonts={system:{labelKey:'font.ui.system' as MessageKey,css:'-apple-system, BlinkMacSystemFont, "Segoe UI", "PingFang SC", "Microsoft YaHei", sans-serif'},sans:{labelKey:'font.ui.sans' as MessageKey,css:'Arial, "PingFang SC", "Microsoft YaHei", sans-serif'},serif:{labelKey:'font.ui.serif' as MessageKey,css:'Georgia, "Songti SC", "SimSun", serif'}};
...
export const settingCategories:Record<string,MessageKey>={general:'settings.category.general',editor:'settings.category.editor',compile:'settings.category.compile',references:'settings.category.references',ai:'settings.category.ai'};
