...
const en: Messages = {
  ...
  "extensions.rtl.hint":
    "Use slang-server for semantic features or choose Verible LSP. Verible provides formatting and live style checks. Install Verilator or Vivado separately for whole-project checks.",
  "extensions.rtl.project": "RTL project",
  "extensions.rtl.projectHint":
    "Paths are relative to this workspace. Enter one item per line; source order is preserved. Saving synchronizes language-server project settings. Reopen RTL editors after changing the file list. Project checks save open drafts first and do not run synthesis.",
  "extensions.rtl.top": "Top module",
  "extensions.rtl.filelist": "File list (.f, optional)",
  "extensions.rtl.files": "Source files in compile order",
  "extensions.rtl.includes": "Include directories",
  "extensions.rtl.defines": "Macro definitions",
  "extensions.rtl.parameters": "Top-level parameters (NAME=VALUE)",
  "extensions.rtl.vivadoProject": "Vivado project (.xpr)",
  "extensions.rtl.importVivado": "Import Vivado project",
  "extensions.rtl.imported": "Project settings imported for review. Save to apply them.",
  "extensions.rtl.save": "Save RTL configuration",
  "extensions.rtl.saved":
    "RTL project configuration saved. Reopen RTL editors to refresh indexing.",
  "extensions.rtl.checkVerilator": "Save and check with Verilator",
  "extensions.rtl.checkVivado": "Save and check with Vivado",
  "extensions.rtl.running": "RTL operation is running…",
  "extensions.rtl.saveFailed": "Save the current project before running RTL checks.",
  "extensions.rtl.passed": "Check completed with no errors; review any warnings below.",
  "extensions.rtl.failed": "Check failed. Review diagnostics and the tool output.",
  "extensions.rtl.log": "Tool output",
