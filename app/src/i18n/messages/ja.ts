...
const ja: Messages = {
  ...
  "extensions.rtl.hint":
    "slang-server または Verible LSP を選択できます。整形とスタイルチェックには Verible、プロジェクト全体の検査には別途 Verilator または Vivado を使用します。",
  "extensions.rtl.project": "RTL プロジェクト",
  "extensions.rtl.projectHint":
    "パスはワークスペース基準で、1 行に 1 項目を入力します。ソースの順序を維持します。設定保存後は RTL エディターを開き直してください。検査前に編集中のファイルを保存します。合成は実行しません。",
  "extensions.rtl.top": "トップモジュール",
  "extensions.rtl.filelist": "ファイルリスト（.f、省略可）",
  "extensions.rtl.files": "ソースファイル（コンパイル順）",
  "extensions.rtl.includes": "インクルードディレクトリー",
  "extensions.rtl.defines": "マクロ定義",
  "extensions.rtl.parameters": "トップレベルパラメーター（NAME=VALUE）",
  "extensions.rtl.vivadoProject": "Vivado プロジェクト（.xpr）",
  "extensions.rtl.importVivado": "Vivado プロジェクトを読み込む",
  "extensions.rtl.imported": "設定を読み込みました。確認して保存してください。",
  "extensions.rtl.save": "RTL 設定を保存",
  "extensions.rtl.saved": "RTL 設定を保存しました。エディターを開き直して索引を更新してください。",
  "extensions.rtl.checkVerilator": "保存して Verilator で検査",
  "extensions.rtl.checkVivado": "保存して Vivado で検査",
  "extensions.rtl.running": "RTL プロジェクトを処理しています…",
  "extensions.rtl.saveFailed": "RTL 検査前にプロジェクトを保存してください。",
  "extensions.rtl.passed": "エラーはありません。警告を確認してください。",
  "extensions.rtl.failed": "検査に失敗しました。診断とツール出力を確認してください。",
  "extensions.rtl.log": "ツール出力",
  ...
  "project.groupCurrent": "現在のプロジェクト",
  "project.groupWorkspace": "ワークスペース",
  ...
  "project.unsavedBadge": "未保存 {count} 件",
