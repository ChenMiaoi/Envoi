...
2. For desktop changes, run `npm run test:desktop` after building; this uses temporary projects and data. For local tool changes, run `npm run test:local` on a compatible Mac.
